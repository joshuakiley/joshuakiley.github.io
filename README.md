...
- [x] Decide whether to look at a card again later in the study session or retire it for the current session
- [X] Hear pronunciation of each Chinese vocabulary word by native speakers
